...
const PROBLEMS = [
  {
    ...
    body: "Due to a lack of rigorous verification for MDCN registrations or HEFAMAA accreditations on existing platforms, Lagos patients must rely on unverified listings and word-of-mouth, leaving their health to chance.",
  },
  {
    icon: "/icons/user_search_regular.svg",
    title: "Healthcare is Hidden",
    body: "Beyond the doctor shortage, the more immediate issue is the invisibility of qualified practitioners, leaving Lagos patients unable to locate neighborhood-specific specialists, view their live availability, or see fees upfront.",
  },
  {
  ...
  },
  {
    ...
    body: "This lack of digital connectivity also affects highly qualified Lagos practitioners, who face unfilled appointment slots simply because they lack a dedicated channel to reach and coordinate with patients needing their care.",
  },
];
    ...
    <section id="problem" className="section-x section-y bg-canvas">
      <div className="mx-auto max-w-[1120px]">
        <SectionHeading
          ...
          subtitle="Nigeria faces a massive doctor-to-patient ratio (1 per 5,000), but the deeper issue in Lagos is a “discovery and trust gap”."
        />
